...
public class DBSSinavTanimla extends Composite {
	...
	public DBSSinavTanimla() {
		...
		absolutePanel.setSize("100%", "461px");
		...
		Label lblDbsSinavTanimla = new Label("DBS SınavTanımla");
		horizontalPanel_2.add(lblDbsSinavTanimla);
		lblDbsSinavTanimla.setWidth("100%");
		...
		if (!isDesignTime()) {
			...
			// grdDBSSinavTanimla.addDomHandler(new ClickHandler() {
			// @Override
